...
class DNN_Tuning:
    ...
    def model_builder(self, hp):
        ...
        hp_units = hp.Int('units', min_value=16, max_value=656, step=16)
        hp_layers = hp.Int('layers', min_value=1, max_value=50, step=1)
    ...
    def dnn_model(self):
        ...
        self.test_results = dnn_model.evaluate(self.test_data, self.test_labels, verbose=0)
    ...
    def kt_tuner(self):
        ...
        tuner.search(self.train_data, self.train_labels, epochs=5000, validation_split=0.2, callbacks=[stop_early])
